...
VACCINE_SCHEDULE = [
    ...
    ("ครั้งที่ 7: 1 ปี 6 เดือน", 365+180, "OPV2, MMR2, DTP4"),
    ("ครั้งที่ 8: 2 ปี 6 เดือน", 365*2+180, "LAJE2"),
...
app = gr.Interface(
    ...
    inputs=gr.Textbox(
        label="วันเกิดเด็ก (DD-MM-YYYY)",
        placeholder="15-01-2025"
    ),
    outputs=gr.Markdown(),
    title="🧒 คำนวณวันรับวัคซีนเด็ก (ตามรอบศูนย์บริการ รพสต.บ้านใหม่)",
    description="คำนวณตามเกณฑ์วัคซีนเด็ก และวันให้บริการจริงของศูนย์ (เดือนละ 1 ครั้ง)"
)
